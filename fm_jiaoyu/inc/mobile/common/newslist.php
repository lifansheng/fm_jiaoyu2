 ...
 */
		...
		$list = pdo_fetchall("SELECT * FROM ".tablename($this->table_news)." WHERE weid = '{$_W['uniacid']}' And (schoolid = '{$schoolid}' OR FIND_IN_SET('{$schoolid}',schoolidstr)) $condition ORDER BY displayorder DESC, id DESC");
