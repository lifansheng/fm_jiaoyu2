 ...
 * @Discription:  
 * @Author: Hannibal·Lee
 * @Date: 2017-11-14 15:29:44
 * @LastEditTime : 2020-01-08 17:18:11
 */
/**
 * 微教育模块
 *
 ...
 */
        ...
        if(!empty($userid['id'])){
			...
			$allqh = pdo_fetchall("SELECT sid,sname FROM " . tablename($this->table_classify) . " where schoolid = '{$schoolid}' And weid = '{$weid}' And type = 'score' AND is_show_qh = 1 ORDER BY sid ASC, ssort DESC");
