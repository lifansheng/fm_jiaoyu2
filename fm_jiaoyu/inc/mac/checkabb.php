        ...
        if($users){
            foreach($users as $key => $row){
                if($row['USERTYPE'] == 1){
                    ...
                    $users[$key]['baby_avatar']        = tomedia($teacher['thumb'],false,true);
                    ...
                    $users[$key]['avatar']    = empty($student['icon']) ? tomedia($school['spic'],false,true) : tomedia($student['icon'],false,true);
                    if($row['PARD'] == 1){
                    ...
                    $users[$key]['baby_name_for_read'] = '';
                    $users[$key]['baby_avatar']        = tomedia($student['icon'],false,true);
					...
					foreach($parter as $k => $r){
						if($row['card_id'] != $r['idcard']){
							...
							$parter[$k]['avatar'] = tomedia($r['spic'],false,true);
						}
					}
